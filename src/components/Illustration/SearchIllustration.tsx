...
export default function SearchIllustration() {
  return (
    ...
    >
      ...
      <LargeCircle filter="url(#filter0_f_24_6)">
        <circle
          cx="159"
          cy="159"
          r="152.5"
      ...
      <MiddleCircle filter="url(#filter1_f_24_6)">
        <circle
          cx="159"
          cy="159"
          r="137.5"
      ...
      <defs>
        ...
        >
          ...
          <feGaussianBlur
            stdDeviation="2"
            result="effect1_foregroundBlur_24_6"
          />
        </filter>
        <filter
          id="filter1_f_24_6"
